...
export default function Dashboard() {
  return (
    <div style={mainContainerStyle}>
      <Paper style={{...paperStyle,padding: "0.5em 1em", display: "flex", justifyContent: "space-evenly"}}>
      <FormControl>
        ...
        <TextField style={{margin: '0 5px'}} helperText='Current Postal Code' value='M5V 1R2' />
      ...
      <Paper style={paperStyle}>
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="card">
              <div style={{background: '#24B5C9'}} className="card-header card-chart card-header-success">
                {ProjectedValueChart}
              </div>
              <div className="card-body">
      ...
      <h2>News Articles</h2>
                <div class="row">
                    <div class="col-md-4" >
                        <div class="card" >
                            <img class="card-img-top" src="https://picsum.photos/100/50" alt="Card"/>
                            <div class="card-body">
                    ...
                    <div class="col-md-4" >
                        <div class="card" >
                            <img class="card-img-top" src="https://picsum.photos/100/50?random" alt="Card"/>
                            <div class="card-body">
                                <h4 class="card-title">News Article</h4>
                                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                    ...
                    <div class="col-md-4" >
                        <div class="card" >
                            <img class="card-img-top" src="https://picsum.photos/g/100/50?random" alt="Card"/>
                            <div class="card-body">
                                <h4 class="card-title">News Article</h4>
                                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
